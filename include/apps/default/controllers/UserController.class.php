...
class UserController extends CommonController
{
    ...
    public function account_raply()
    {
        ...
        $pay_fee = $this->model->table("values_list")->where("id=7")->field("value")->getOne();
    ...
    public function register()
    {
        ...
        if (IS_POST) {
            ...
            if (0 == $enabled_sms) {
                ...
                //var_dump($parent_phone);
                //判断推荐人是否存在
                if($parent_phone!=''){
                    var_dump($parent_phone);
                     $parent = $this->model->table('users')->where("user_name='$parent_phone'")->find();
                     var_dump($parent);
                     if(!$parent){
                        show_message("推荐人不存在");
                     }                 
            ...
            $other['parent_id'] = $parent['user_id'] ? $parent['user_id'] : 0;
